	            ...
	            <div class="allow_listing">
	            	<table>
	            		...
	            		<tr>
	            			...
	            			<td>'.$listing_details_row['22'].'</td>
	            		</tr>

	            	</table>
	            	<a href="allowed_listing.php?id='. $listing_details_row['0'] .'" class="allow">Allow Listing</a>
	            	<a href="reject_listing.php?id='. $listing_details_row['0'] .'" class="reject">Reject Listing</a>
	            	<a href="https://api.whatsapp.com/send?phone=+91'.$listing_details_row['11'].'" class="reject">Whatsapp</a>
	            </div>
			';
...
?>
<title>Getlisting - <?php echo $listing_details_row['1']; ?></title>