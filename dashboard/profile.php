...
<?php 	
        ...
        if (mysqli_num_rows($user)>0) 
        {
            ...
            ?>
            <title><?php echo ucfirst($user_row['1'])." - Profile"; ?></title>
            <?php
            echo "
	            ...
	            <div class='update_profile update'>
					<form method='POST'>
						...
						<label>Email</label><label style='background: rgba(0, 0, 0, 0.075);padding-top: 2%;padding-bottom: 2%;padding-left: 2%;border-radius: 4px;'>{$user_row['2']}</label>
						<label>Contact</label><label style='background: rgba(0, 0, 0, 0.075);padding-top: 2%;padding-bottom: 2%;padding-left: 2%;border-radius: 4px;'>{$user_row['3']}</label>
        ...
        elseif (mysqli_num_rows($free)>0) 
        {
            ...
            ?>
            <title><?php echo ucfirst($free_row['1'])." - Profile"; ?></title>
            <?php
        	echo "
	            <div class='bread_crumb'>
	            	<label><a href='home.php' class='a_left'>Home</a>/<a href='profile.php' class='a_right'>Profile</a></label>
	            ...
	            <div class='update_profile update'>
					<form method='POST'>
						...
						<label>Email</label><label style='background: rgba(0, 0, 0, 0.075);padding-top: 2%;padding-bottom: 2%;padding-left: 2%;border-radius: 4px;'>{$free_row['2']}</label>
						<label>Contact</label><label style='background: rgba(0, 0, 0, 0.075);padding-top: 2%;padding-bottom: 2%;padding-left: 2%;border-radius: 4px;'>{$free_row['3']}</label>
        ...
        elseif (mysqli_num_rows($standard)>0)
        {
            ...
            ?>
            <title><?php echo ucfirst($standard_row['1'])." - Profile"; ?></title>
            <?php
        	echo "
	            <div class='bread_crumb'>
	            	<label><a href='home.php' class='a_left'>Home</a>/<a href='profile.php' class='a_right'>Profile</a></label>
	            ...
	            <div class='update_profile update'>
					<form method='POST'>
						...
						<label>Email</label><label style='background: rgba(0, 0, 0, 0.075);padding-top: 2%;padding-bottom: 2%;padding-left: 2%;border-radius: 4px;'>{$standard_row['2']}</label>
						<label>Contact</label><label style='background: rgba(0, 0, 0, 0.075);padding-top: 2%;padding-bottom: 2%;padding-left: 2%;border-radius: 4px;'>{$standard_row['3']}</label>
            ...
            {
            	$name = $_POST['name'];
            	$email = $standard_row['2'];
            	$contact = $standard_row['3'];
            	$password = $_POST['password'];
        ...
        elseif (mysqli_num_rows($premium)>0)
        {
            ...
            ?>
            <title><?php echo ucfirst($premium_row['1'])." - Profile"; ?></title>
            <?php
            echo "
	            <div class='bread_crumb'>
	            	<label><a href='home.php' class='a_left'>Home</a>/<a href='profile.php' class='a_right'>Profile</a></label>
	            ...
	            <div class='update_profile update'>
					<form method='POST'>
						...
						<label>Email</label><label style='background: rgba(0, 0, 0, 0.075);padding-top: 2%;padding-bottom: 2%;padding-left: 2%;border-radius: 4px;'>{$premium_row['2']}</label>
						<label>Contact</label><label style='background: rgba(0, 0, 0, 0.075);padding-top: 2%;padding-bottom: 2%;padding-left: 2%;border-radius: 4px;'>{$premium_row['3']}</label>
