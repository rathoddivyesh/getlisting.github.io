...
<?php 	
        ...
        if (mysqli_num_rows($free)>0) 
        {
        	...
        	?>
        	<title><?php echo ucfirst($free_row['1'])." - Add Blog"; ?></title>
        	<?php
            echo "
	            ...
	            <div class='change_password'>
					...
					<form class='authen_form blog_upload' method='POST' enctype='multipart/form-data'>
						...
						<textarea name='blog_description' rows='5' cols='6' placeholder='Blog Description' required></textarea><br>
            ...
            if (isset($_POST['submit']))
			{
				...
				if(move_uploaded_file($_FILES['blog_image']['tmp_name'], $new_filename1))
				{
					...
					{
						echo "<script>alert('Your Blog is Posted')</script>";
				...
				{
					echo"<script>alert('Blog Can Not Posted')</script>";
				}
	   		}
        }
        elseif (mysqli_num_rows($standard)>0)
        {
        	...
        	?>
        	<title><?php echo ucfirst($standard_row['1'])." - Add Blog"; ?></title>
        	<?php
            echo "
	            <div class='bread_crumb'>
	            	<label><a href='home.php' class='a_left'>Home</a>/<a href='add_blog.php' class='a_right'>Add Blog</a></label>
        ...
        elseif (mysqli_num_rows($premium)>0)
        {
        	...
        	?>
        	<title><?php echo ucfirst($premium_row['1'])." - Add Blog"; ?></title>
        	<?php
            echo "
	            <div class='bread_crumb'>
	            	<label><a href='home.php' class='a_left'>Home</a>/<a href='add_blog.php' class='a_right'>Add Blog</a></label>
