...
<?php 	
        ...
        {
        	?>
        	<title><?php echo ucfirst($standard_row['1'])." - Add Announcement"; ?></title>
        	<?php
            ...
            echo "
	            ...
	            <div class='change_password'>
					...
					<form class='authen_form' method='POST'>
						<input type='text' placeholder='Announcement Title' name='announcement_title' required>
						<textarea name='announcement_description' rows='5' cols='6' placeholder='Announcement Description' required></textarea><br>
            ...
            if (isset($_POST['submit']))
			{
				...
				$insert_query = mysqli_query($conn,"INSERT INTO announcement (listing_id,member_email,announcement_title,announcement_description,announcement_date,listing_name) VALUES ('$listing_id','$member_email','$announcement_title','$announcement_description','$announcement_date','$listing_name') ");
