...
<title>Getlisting - Pricing Plans</title>
<?php  
...
?>
	<div class="plans">
			...
			<div class="free">
				...
				<h4>&#10004; One Listing</h4>
				<h4>&#10004; Unlimited Blogs</h4>
				<h4>&#10004; Limited Support</h4>
				<h4>&#10004; one Image Gallery</h4>
				<h4>&#10004; Edit Your Listing</h4>
				<hr>
				<?php echo '<a href="add_listing.php?package='. $package_free .'">Get Started</a>'; ?>
			</div>
			<div class="premium">
				<label>Premium</label>
				<hr>
				...
				<hr>
				<?php echo '<a href="add_listing.php?package='. $package_premium .'">Get Started</a>'; ?>
			</div> 
			<div class="standard">
				...
				<hr>
				<?php echo '<a href="add_listing.php?package='. $package_standard .'">Get Started</a>'; ?>
			</div>
