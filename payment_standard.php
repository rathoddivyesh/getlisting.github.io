...
<?php  
	...
	if (isset($_POST['submit']))
	{
		...
		if ($insert_package == TRUE) 
		{
			...
			$update_member = mysqli_query($conn,"UPDATE user_type SET type = 'standard' WHERE id='{$_SESSION['id']}' ");
...
<div class="payment">
	<form method="POST">
		...
		<label>Amount</label>
		<input type="text" name="amount" value="3999" placeholder="&#8377"  readonly  required>
